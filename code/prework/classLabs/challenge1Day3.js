function gooseFilter (birds) {
  ...
  for (let birdsIndex = 0 ; birdsIndex < birds.length ; ++birdsIndex){
    let found = false;
    
    for (let geeseIndex = 0 ; geeseIndex < geese.length ; ++geeseIndex){
      if (birds[birdsIndex] === geese[geeseIndex]){
        found = true;
        break;
      }
    }
